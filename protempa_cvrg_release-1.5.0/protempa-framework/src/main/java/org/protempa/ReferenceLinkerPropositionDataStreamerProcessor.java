...
/**
 * After propositions have been assembled for a given key id, this
 * {@link PropositionDataStreamerProcessor} assembles all of the references
...
final class ReferenceLinkerPropositionDataStreamerProcessor
    ...
    ReferenceLinkerPropositionDataStreamerProcessor(
            List<? extends DataStreamingEventIterator<UniqueIdPair>> refItrs) {
