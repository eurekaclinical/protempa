...
public class PrimitiveParameterStreamingRefResultProcessor extends StreamingRefResultProcessor<PrimitiveParameter> {
    ...
    @Override
    ReferenceResultSetIterator newIterator(ResultSet resultSet, ReferenceSpec referenceSpec, EntitySpec entitySpec, String dataSourceBackendId, StreamingRefResultProcessor<PrimitiveParameter> processor) throws SQLException {
        return new ReferenceResultSetIterator(resultSet, referenceSpec, entitySpec, dataSourceBackendId, processor);
    }
