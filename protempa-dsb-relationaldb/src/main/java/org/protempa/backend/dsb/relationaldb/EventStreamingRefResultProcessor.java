...
public class EventStreamingRefResultProcessor extends StreamingRefResultProcessor<Event> {
    ...
    @Override
    ReferenceResultSetIterator newIterator(ResultSet resultSet, ReferenceSpec referenceSpec, EntitySpec entitySpec, String dataSourceBackendId, StreamingRefResultProcessor<Event> processor) throws SQLException {
