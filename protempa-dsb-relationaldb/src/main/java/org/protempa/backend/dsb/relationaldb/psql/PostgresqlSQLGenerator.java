...
public class PostgresqlSQLGenerator 
    ...
    private static final MajorMinorVersion MIN_DATABASE_VERSION = new MajorMinorVersion(9, 1);
    private static final MajorMinorVersion MAX_DATABASE_VERSION = new MajorMinorVersion(9, Integer.MAX_VALUE);
