...
abstract class FromClause implements SQLClause {
    ...
    protected FromClause(List<ColumnSpec> columnSpecs,
    ...
    protected abstract OnClause getOnClause(int fromIndex, int toIndex,
