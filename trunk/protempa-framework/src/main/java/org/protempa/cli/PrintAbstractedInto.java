 ...
 * @author Andrew Post
 */
public class PrintAbstractedInto extends CLI {

    public PrintAbstractedInto() {
    ...
    public void execute(Protempa protempa, CommandLine commandLine)
        ...
        try {
            List<? extends PropositionDefinition> result =
                    knowledgeSource.readAbstractedInto(propositionId);
    ...
    public static void main(String[] args) {
        PrintAbstractedInto pl = new PrintAbstractedInto();
