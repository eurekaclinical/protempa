...
public final class MinAlgorithm extends AbstractAlgorithm {
	...
	public MinAlgorithm(Algorithms algorithms, String id) {
		...
		setParameters(new AlgorithmParameter[] {
				new AlgorithmParameter("maxThreshold", new ValueComparator[] {
						...
						ValueComparator.EQUAL_TO }, ValueFactory.NUMERICAL),
	...
	public Value compute(Segment<PrimitiveParameter> segment,
		...
		if (minVal != null
				&& (minThresholdComp == null || minThreshold == null || minThresholdComp
						.getConsistent(minVal.compare(minThreshold)))
				&& (maxThresholdComp == null || maxThreshold == null || maxThresholdComp
						.getConsistent(minVal.compare(maxThreshold)))) {
