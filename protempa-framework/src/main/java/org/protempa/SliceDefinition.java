 ...
 * 
 */
public final class SliceDefinition extends
	...
	protected String debugMessage() {
		...
		buffer.append("\tabstractedFrom=" + abstractedFrom + "\n");
		buffer.append("\tminIndex=" + minIndex + "\n");
		buffer.append("\tmaxIndex=" + maxIndex + "\n");
	...
	protected void recalculateDirectChildren() {
		...
		this.directChildren = this.abstractedFrom
				.toArray(new String[this.abstractedFrom.size()]);
