...
public final class AbsoluteTimeGranularity implements Granularity {
    ...
    private static final DateFormat[] longDateFormats = {
        new SimpleDateFormat(resourceBundle.getString("long_date_format_gran_sec")),
        new SimpleDateFormat(resourceBundle.getString("long_date_format_gran_min")),
        new SimpleDateFormat(resourceBundle.getString("long_date_format_gran_hr")),
        new SimpleDateFormat(resourceBundle.getString("long_date_format_gran_day")),
        new SimpleDateFormat(resourceBundle.getString("long_date_format_gran_month")),
        new SimpleDateFormat(resourceBundle.getString("long_date_format_gran_yr"))};
    private static final DateFormat[] reprFormats = {
        new ReprSimpleDateFormat(resourceBundle.getString("long_date_format_gran_sec")),
        new ReprSimpleDateFormat(resourceBundle.getString("long_date_format_gran_min")),
        new ReprSimpleDateFormat(resourceBundle.getString("long_date_format_gran_hr")),
        new ReprSimpleDateFormat(resourceBundle.getString("long_date_format_gran_day")),
        new ReprSimpleDateFormat(resourceBundle.getString("long_date_format_gran_month")),
        new ReprSimpleDateFormat(resourceBundle.getString("long_date_format_gran_yr"))};
    private static final DateFormat[] longDateFormatsNoYear = {
        new SimpleDateFormat(resourceBundle.getString("long_date_format_gran_sec_no_yr")),
        new SimpleDateFormat(resourceBundle.getString("long_date_format_gran_min_no_yr")),
        new SimpleDateFormat(resourceBundle.getString("long_date_format_gran_hr_no_yr")),
        new SimpleDateFormat(resourceBundle.getString("long_date_format_gran_day_no_yr")),
        new SimpleDateFormat(resourceBundle.getString("long_date_format_gran_month_no_yr")),
        new SimpleDateFormat(resourceBundle.getString("long_date_format_gran_yr_no_yr"))};
    private static final DateFormat[] mediumDateFormats = {
        new SimpleDateFormat(resourceBundle.getString("med_date_format_gran_sec")),
        new SimpleDateFormat(resourceBundle.getString("med_date_format_gran_min")),
        new SimpleDateFormat(resourceBundle.getString("med_date_format_gran_hr")),
        new SimpleDateFormat(resourceBundle.getString("med_date_format_gran_day")),
        new SimpleDateFormat(resourceBundle.getString("med_date_format_gran_month")),
        new SimpleDateFormat(resourceBundle.getString("med_date_format_gran_yr"))};
    private static final DateFormat[] mediumDateFormatsNoYear = {
        new SimpleDateFormat(resourceBundle.getString("med_date_format_gran_sec_no_yr")),
        new SimpleDateFormat(resourceBundle.getString("med_date_format_gran_min_no_yr")),
        new SimpleDateFormat(resourceBundle.getString("med_date_format_gran_hr_no_yr")),
