...
public class PropositionUtil {
	...
	private static class TemporalPropositionComparator<T extends TemporalProposition>
	...
	private static class MaxFinishTemporalPropositionComparator<T extends TemporalProposition>
			implements Comparator<T>, Serializable {
	...
	public static final Comparator<TemporalProposition> TEMPORAL_PROPOSITION_COMPARATOR = new TemporalPropositionComparator<TemporalProposition>();

	public static final Comparator<TemporalProposition> MAX_FINISH_COMPARATOR = new MaxFinishTemporalPropositionComparator<TemporalProposition>();

	public static final Comparator<TemporalProposition> REVERSE_TEMPORAL_PROPOSITION_COMPARATOR = Collections
			.reverseOrder(TEMPORAL_PROPOSITION_COMPARATOR);
