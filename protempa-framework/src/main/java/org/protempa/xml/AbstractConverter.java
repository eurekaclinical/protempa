...
abstract class AbstractConverter implements Converter {
     ...
     * name.
     *
     * @param reader      The object used to inquire about the current XML element.
     * @param elementName The expected element name
     * @throws ConversionException if the current element does not have the expected name.
     */
     ...
     *
     * @param reader       The object used to inquire about the current XML element.
     * @param elementNames The expected element names.
     ...
     *
     * @param reader The object used to inquire about the current XML element.
     * @throws ConversionException if the current element has any unprocessed children.
     */
     ...
     * @param attributeName The name of the attribute to get a value for.
     * @return The value of the attribute.
     * @throws ConversionException if the specified value of the attribute can not be parsed as
     *                             an int.
     */
     ...
     * @param reader        The object used to inquire about the current XML element.
     * @param attributeName The name of the attribute to get a value for.
     * @param defaultValue  The default value to use if the named attribute is not
     *                      specified.
     * @return The value of the attribute.
     * @throws ConversionException if the specified value of the attribute can not be parsed as
     *                             an int.
     ...
     * @param attributeName The name of the attribute to get a value for.
     * @return The value of the attribute.
     * @throws ConversionException if the specified value of the attribute can not be recognized
     *                             as a Unit.
     */
     ...
     *
     * @param writer  The {@link} HierarchicalStreamWriter} object that XStream
     *                passed into a marshal method.
     * @param context The {@link MarshallingContext} object that XStream passed into
     *                a marshal method.
     ...
     *
     * @param propertyName The property name whose value is the URL of interest.
     */
