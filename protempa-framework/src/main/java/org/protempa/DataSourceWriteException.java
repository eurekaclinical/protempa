...
public class DataSourceWriteException extends DataSourceException {
    ...
    public DataSourceWriteException(List<DataSourceWriteException> causes) {
        super(exceptionsToString(causes));
    }
    
    private static String exceptionsToString(List<DataSourceWriteException> causes) {
        StringBuilder stackTrace = new StringBuilder();
        for (DataSourceWriteException ex : causes) {
