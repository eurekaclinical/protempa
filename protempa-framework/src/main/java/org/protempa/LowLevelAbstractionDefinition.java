...
public final class LowLevelAbstractionDefinition extends
	...
	private ValueFactory valueType;
	...
	public LowLevelAbstractionDefinition(KnowledgeBase kb, String id) {
		...
		this.valueDefinitions = new ArrayList<LowLevelAbstractionValueDefinition>(
				5);
		this.valueType = ValueFactory.NOMINAL;
	...
	public LowLevelAbstractionValueDefinition getValueDefinition(String id) {
		for (int i = 0, n = this.valueDefinitions.size(); i < n; i++) {
			LowLevelAbstractionValueDefinition def = (LowLevelAbstractionValueDefinition) valueDefinitions
					.get(i);
	...
	public void setValueType(ValueFactory c) {
		if (c != null) {
			this.valueType = c;
		}
	}
	...
	protected String debugMessage() {
		...
		buffer.append("minimumPatternLength=" + minimumNumberOfValues + ", ");
		buffer.append("maximumPatternLength=" + maximumNumberOfValues + ", ");
		buffer.append(this.gapBtwValues.debugMessage());
		buffer.append("maxOverlapping=" + maxOverlapping + ", ");
		buffer.append("skip=" + skip + ", ");
		buffer.append("skipStart=" + skipStart + ", ");
		buffer.append("skipEnd=" + skipEnd + ", ");
		for (LowLevelAbstractionValueDefinition savd : valueDefinitions) {
			buffer.append("\t" + savd.debugMessage() + "\n");
		}
