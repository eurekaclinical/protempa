...
/**
 * Castor field handler for Query.keyIds
 * 
 * @author mgrand
 */
public class QueryCastorKeyIdsHandler implements FieldHandler {

	/**
	 * Constructor
	 */
	public QueryCastorKeyIdsHandler() {
