...
public class SimpleAbstractParameterIntervalTest extends TestCase {

	private static final DateFormat DATE_FORMAT = DateFormat
			.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT, Locale.US);

	private Date d;
	private SimpleAbstractParameterInterval interval;

	@Override
	protected void setUp() throws Exception {
		d = DATE_FORMAT.parse("1/1/07 1:00 am");
		this.interval = new SimpleAbstractParameterInterval(d.getTime(),
	...
	public void test12HoursMinDistance() throws ParseException {
		...
		Interval i2 = new SimpleAbstractParameterInterval(d.getTime(),
	...
	public void test12HoursReallyInHoursGranularity() throws ParseException {
		...
		Interval i2 = new SimpleAbstractParameterInterval(d.getTime(),
				AbsoluteTimeGranularity.MINUTE, d2.getTime(),
				AbsoluteTimeGranularity.MINUTE);
		long distance = AbsoluteTimeGranularity.MINUTE.distance(interval
				.getMinStart(), i2.getMinFinish(), i2.getFinishGranularity(),
	...
	public void testOneMinuteMinDistance() throws ParseException {
		...
		Interval i2 = new SimpleAbstractParameterInterval(d.getTime(),
				AbsoluteTimeGranularity.MINUTE, d2.getTime(),
				AbsoluteTimeGranularity.MINUTE);
		assertEquals(Long.valueOf(60L), i2
				.minLengthIn(AbsoluteTimeUnit.SECOND));
	}
