...
public abstract class AbstractHELLPOneKeyTest extends AbstractTest {
	...
	private static final List<String> HELLP_II_RECURRING_RECOVERY = Arrays
			.asList(new String[] { "HELLP_II",
					"HELLP_FIRST_RECOVERING_PLATELETS",
					"HELLP_RECURRING_PLATELETS",
					"HELLP_RECURRING_AND_RECOVERING_PLATELETS" });

	private static final List<String> HELLP_I_RECURRING_RECOVERY = Arrays
			.asList(new String[] { "HELLP_I",
					"HELLP_FIRST_RECOVERING_PLATELETS",
					"HELLP_RECURRING_PLATELETS",
					"HELLP_RECURRING_AND_RECOVERING_PLATELETS" });

	private static final List<String> HELLP_I_RECCURING = Arrays
			.asList(new String[] { "HELLP_I",
					"HELLP_FIRST_RECOVERING_PLATELETS",
					"HELLP_RECURRING_PLATELETS" });

	private static final List<String> HELLP_I_RECOVERY = Arrays
			.asList(new String[] { "HELLP_I",
					"HELLP_FIRST_RECOVERING_PLATELETS" });

	private static final List<String> HELLP_II_RECOVERY = Arrays
			.asList(new String[] { "HELLP_II",
					"HELLP_FIRST_RECOVERING_PLATELETS" });

	private static final List<String> HELLP_II = Arrays
			.asList(new String[] { "HELLP_II" });

	private static final List<String> HELLP_I = Arrays
			.asList(new String[] { "HELLP_I" });
	...
	private void runTest(String keyId, Collection<String> expected)
		...
		Collection<Proposition> actual = protempa.execute(
                SimpleQuery.newInstance(keyId, ALL_PARAMETERS)).get(keyId);
