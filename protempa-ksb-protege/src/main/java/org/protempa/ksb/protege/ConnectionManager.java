...
abstract class ConnectionManager {
		...
		if (protegeKnowledgeBase != null && getter != null) {
			...
			do {
				try {
					...
					Util.logger().log(
							Level.WARNING,
							"Exception attempting to " + getter.getWhat() + " "
									+ obj, e);
					tries--;
				}
				close();
                ...
                throw new KnowledgeSourceReadException(
					"Failed to " + getter.getWhat() + " " + obj + " after "
	...
	private final ProtegeCommand<Instance, InstanceSpecMultipleInheritance> 
	...
	private final ProtegeCommand<Collection<Cls>, Instance> DIRECT_TYPES_GETTER 
            = new ProtegeCommand<Collection<Cls>, Instance>(
            "get direct types") {
	...
	private final ProtegeCommand<Object, SetSlotValueSpec> 
            OWN_SLOT_VALUE_SETTER = new ProtegeCommand<Object,
            SetSlotValueSpec>("set own slot value") {
	...
	private final ProtegeCommand<Object, SetSlotValuesSpec> 
            OWN_SLOT_VALUES_SETTER = new ProtegeCommand<Object,
            SetSlotValuesSpec>("set own slot value") {
